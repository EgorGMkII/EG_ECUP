"""Fresh full-history submission builder: CatBoost Cadence Specialist (0.70) + ETT Direct (0.30)."""
...
def main() -> None:
    ...
    ap.add_argument("--output-root", type=Path, default=Path("artifacts/direct_cb_cadence_ett_submission"))
    ...
    # Blend 70% CatBoost Cadence Specialist + 30% ETT Direct
    print("[*] Blending predictions (0.70 CB Cadence + 0.30 ETT Direct)...", flush=True)
    z_blend = 0.70 * cb_res.prediction_z + 0.30 * ett_res.prediction_z
    ...
    report = {
        "experiment_id": "direct_cb_cadence_ett_submission_v1",
        ...
        "weights": {
            "catboost_cohort_specialist_cadence": 0.70,
            "ett_direct": 0.30,
        },
        "models": {
            "catboost_cohort_specialist_cadence": cb_res.training_report,
